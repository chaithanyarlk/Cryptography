...
void bruteForce(vector<string> cipher){
     cout<<"\nBrute Force works well when size of key is small! This is for 2 bit key "<<endl;
     int k = pow(2.0,(float)n_bit);
     for(int i = 0;i<k;i++){
          bitset<n_bit>b(i);
          cout<<i<<endl;
          ...
          vector<int>keyStream = keySchedulingAlgorithm(key_vec,cipher.size());
