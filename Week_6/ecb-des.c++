...
string electronicCodeBlockEncryption(string s,vector<string>&roundkeysBin,vector<string>&roundkeysHex){
     string res = "";
     for(int i = 0;i<s.size();i=i+16){
          res += encryptionAlgo(s.substr(i,16),roundkeysBin,roundkeysHex);
     }
     return res;
}
string electronicCodeBlockDecryption(string s,vector<string>&roundkeysBin,vector<string>&roundkeysHex){
...
int main(){
    ...
    cout<<"ECB Encryption Begins ..."<<endl;
    string cipher = electronicCodeBlockEncryption(plain,roundkeysBin,roundkeysHex);
    cout<<"Encrypted String ... "<<cipher<<endl;
    cout<<"ECB Decryption Begins ..."<<endl;
    string decrypt = electronicCodeBlockDecryption(cipher,roundkeysBin,roundkeysHex);
