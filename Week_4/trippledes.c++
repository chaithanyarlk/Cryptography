...
void trippleDES (string plain,string key1,string key2,string key3){
     string keyBin1 = hextoBin(key1);
     key1 = permutationAlgo(keyBin1,keyparity,56);
     vector<string>roundkeysBin1,roundkeysHex1;
     roundKeysGenerator(key1,roundkeysBin1,roundkeysHex1);
     string keyBin2 = hextoBin(key2);
     key2 = permutationAlgo(keyBin2,keyparity,56);
     vector<string>roundkeysBin2,roundkeysHex2;
     roundKeysGenerator(key2,roundkeysBin2,roundkeysHex2);
     string keyBin3 = hextoBin(key3);
     key3 = permutationAlgo(keyBin3,keyparity,56);
     vector<string>roundkeysBin3,roundkeysHex3;
     roundKeysGenerator(key3,roundkeysBin3,roundkeysHex3);
     cout<<"Encryption Begins ..."<<endl;
     string cipher1 = encryptionAlgo(plain,roundkeysBin1,roundkeysHex1);
     cout<<"First key encryption ... "<<cipher1<<endl;
     reverse(roundkeysBin2.begin(),roundkeysBin2.end());
     reverse(roundkeysHex2.begin(),roundkeysHex2.end());
     string dec1 = decryptHelper(cipher1,roundkeysBin2,roundkeysHex2);
     cout<<"Second key decryption ... "<<dec1<<endl;
     string cipher2 = encryptionAlgo(dec1,roundkeysBin3,roundkeysHex3);
     cout<<"Final Cipher Message ... "<<cipher2<<endl;
     cout<<"Decryption Begins ..."<<endl;
     string dec2 = decryptHelper(cipher2,roundkeysBin3,roundkeysHex3);
     cout<<"Decryption of 3rd key ..."<<dec2<<endl;
     reverse(roundkeysBin2.begin(),roundkeysBin2.end());
     reverse(roundkeysHex2.begin(),roundkeysHex2.end());
     string enc2 = encryptionAlgo(dec2,roundkeysBin2,roundkeysHex2);
     cout<<"Encryption of 2nd key ..."<<enc2<<endl;
     string final_str = decryptHelper(enc2,roundkeysBin1,roundkeysHex1);
     cout<<"Decrypted Final Message ..."<<final_str<<endl;
}

int main(){
    init();
    string plain, key1,key2,key3;
    cout<<"Enter message of 16 characters ..."<<endl;
    cin>>plain;
    cout<<"Enter key1 of 16 characters ..."<<endl;
    cin>>key1;
    cout<<"Enter key2 of 16 characters ..."<<endl;
    cin>>key2;
    cout<<"Enter key3 of 16 characters ..."<<endl;
    cin>>key3;
    trippleDES(plain,key1,key2,key3);
}
